...
노드 실행 시 `--validator-wallet`을 지정하면 validator 주소가 자동으로 merchant 주소가 됩니다.
명시적으로 다른 주소를 사용하려면 `--ai-merchant-address`를 추가합니다.

```powershell
python -m neworder --validator-wallet validator1.json --validators NO1...,NO2...,NO3... --ai-merchant-address NO...
```
